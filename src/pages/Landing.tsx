    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/30">
        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">VARIS Demo</p>
            </div>
          </div>
      ...
      <section className="container mx-auto px-6 py-16 text-center">
        <h1 className="text-5xl font-bold tracking-tight mb-6">
          VARIS — Vigilant Agile Risk & Integrity Suite
        </h1>
      ...
      <section className="container mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-center mb-12">Four Pillars of Customs Vigilance</h2>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-semibold">Revenue Assurance</h3>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-semibold">Society Protection</h3>
                <p className="text-muted-foreground">
                  Early warning for illicit goods through route analysis, keyword detection, and document verification.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-semibold">Integrity Analytics</h3>
                <p className="text-muted-foreground">
                  Detect insider threats through pattern analysis, audit trail monitoring, and behavioral baselines.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <h3 className="text-xl font-semibold">Risk Agility</h3>
                <p className="text-muted-foreground">
                  Dynamic rule adaptation with simulation, version control, and governed rollback capabilities.
                </p>
              </div>
            </CardContent>
          </Card>
