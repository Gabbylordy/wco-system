...
// //   const runAIAnalysis = () => {
// //     setLoading(true);
// //     toast.info("🤖 AI is analyzing patterns...", {
// //       description: "Machine learning models are processing data",
// //     });
...
// //         efficiencyGain: 42,
// //         topPatterns: [
// //           { pattern: "Midnight ordering spikes", confidence: 92, impact: "HIGH" },
// //           { pattern: "Repeat offender detection", confidence: 88, impact: "HIGH" },
// //           { pattern: "Geo-clustering fraud", confidence: 76, impact: "MEDIUM" },
// //           { pattern: "Price manipulation", confidence: 81, impact: "HIGH" },
// //         ],
// //         predictions: [
// //           { id: 1, type: "Fraud Probability", current: 12, predicted: 25, confidence: 85 },
// //           { id: 2, type: "Revenue Growth", current: 100, predicted: 142, confidence: 78 },
// //           { id: 3, type: "Risk Reduction", current: 45, predicted: 18, confidence: 92 },
// //           { id: 4, type: "Processing Time", current: 120, predicted: 68, confidence: 88 },
// //         ],
// //         recommendations: [
// //           "Increase monitoring during 00:00-04:00 hours",
// //           "Flag accounts with >5 same-day orders",
// //           "Implement real-time HS code validation",
// //           "Deploy predictive duty calculator"
// //         ]
// //       };

// //       setAiInsights(mockInsights);
// //       setPredictions(mockInsights.predictions);
// //       setLoading(false);

// //       toast.success("✨ AI Analysis Complete!", {
// //         description: "Intelligence insights generated successfully",
// //         duration: 5000,
// //       });
// //     }, 2000);
// //   };
...
// //           riskPatterns: prev.riskPatterns + (Math.random() > 0.7 ? 1 : 0)
// //         }));
// //       }
// //     }, 5000);
...
// //       {/* Run Analysis Button */}
// //       <Card className="border-2 border-dashed border-blue-300 bg-purple-50/50">
...
// //               </div>
// //               <div>
// //                 <h3 className="text-lg font-semibold">AI-Powered Risk Intelligence</h3>
// //                 <p className="text-sm text-muted-foreground">
// //                   Run machine learning analysis to uncover hidden patterns and predict future risks
// //                 </p>
// //               </div>
// //             </div>
// //             <Button 
...
// //                   <p className="text-xs text-muted-foreground mt-2">AI confidence in detecting irregularities</p>
// //                 </CardContent>
// //               </Card>
...
// //                   <p className="text-xs text-muted-foreground mt-2">Potential revenue with AI optimization</p>
// //                 </CardContent>
// //               </Card>
...
// //                 </CardTitle>
// //                 <CardDescription>Machine learning model outputs and confidence levels</CardDescription>
// //               </CardHeader>
// //               <CardContent>
// //                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
// //                   <div className="space-y-4">
// //                     <h4 className="font-medium">Top Detected Patterns</h4>
// //                     {aiInsights.topPatterns.map((pattern: any, index: number) => (
// //                       <div key={index} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
// //                         <div>
// //                           <div className="font-medium">{pattern.pattern}</div>
// //                           <div className="text-xs text-muted-foreground">Confidence: {pattern.confidence}%</div>
// //                         </div>
...
// //                         </TableCell>
// //                         <TableCell>
// //                           <Badge variant={pred.predicted > pred.current ? "default" : "secondary"}>
// //                             {pred.predicted > pred.current ? "↑ Improving" : "↓ Watch"}
// //                           </Badge>
// //                         </TableCell>
// //                       </TableRow>
// //                     ))}
...
// //                 <CardDescription>Actionable insights from machine learning analysis</CardDescription>
// //               </CardHeader>
// //               <CardContent>
// //                 <div className="space-y-4">
...
// //                             {index === 1 && <AlertTriangle className="h-4 w-4 text-amber-600" />}
// //                             {index === 2 && <FileText className="h-4 w-4 text-blue-600" />}
// //                             {index === 3 && <BarChart3 className="h-4 w-4 text-green-600" />}
// //                           </div>
// //                           <div>
...
// //                               <Button size="sm" variant="ghost">More Info</Button>
// //                             </div>
// //                           </div>
// //                         </div>
// //                       </CardContent>
...
// //           </div>
// //           <div>
// //             <h3 className="text-xl font-semibold">Ready for AI Insights</h3>
...
// //                 <div className="text-sm">Faster Fraud Detection</div>
// //               </CardContent>
// //             </Card>
// //             <Card className="bg-muted/50">
// //               <CardContent className="p-4 text-center">
...
// //               </div>
// //               <div>
// //                 <h4 className="font-medium">Export AI Report</h4>
...
// const runAIAdvancedAnalysis = (data: any[]) => {
...
//     revenue,
//     risks,
//     summary: generateAISummary(data)
//   };
// };
...
//     priceGroups[category].push(parseFloat(item.item_price_inr));
//   });
...
//     const price = parseFloat(item.item_price_inr) * 0.044;
//     return price > 1000;
//   }).length;
...
//     const price = parseFloat(item.item_price_inr);
...
//     const priceAED = parseFloat(item.item_price_inr) * 0.044;
...
//     optimization: Math.round((missedDuty / totalDuty) * 100) || 0
//   };
// };
...
//     totalOrders: total,
//     avgOrderValue: data.reduce((sum, item) => sum + parseFloat(item.item_price_inr), 0) / total
//   };
// };
...
//       const insights = runAIAdvancedAnalysis(rawData);
...
//       toast.success("✨ AI Analysis Complete!", {
//         description: `${insights.patterns.length} patterns detected with ${summary.anomalyScore}% confidence`,
//         duration: 5000,
//       });
//     }, 3000);
//   };
